...
\begin{resume}
    ...
    \textbf{Team Lead / AI Engineer} \hfill September 2025 - January 2026\\
    \textbf{SalusOptima}, Remote\\
    ...
    \textbf{Tech Stack:} Python, FastAPI, LangChain, LangGraph, Neo4j, PostgreSQL, pytest, Azure Kubernetes Service (AKS), Azure AI Foundry, Azure Blob Storage, Docker
