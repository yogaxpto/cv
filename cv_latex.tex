...
\begin{resume}
    ...
    Leading a multidisciplinary engineering team focused on the design and deployment of AI-driven solutions in the due diligence sector leveraging Large Language Models to support risk analysis and decision-making workflows. Actively involved in the selection, onboarding, and ongoing management of new team members, ensuring strong technical alignment and sustained team performance. Architected and implemented LLM-based systems using LangGraph and LangChain, enabling complex reasoning workflows and agentic behaviors. Designed knowledge-augmented AI solutions backed by Neo4j graph databases to support semantic search, contextual retrieval, and decision-support use cases. Deployed and operated AI services on Microsoft Azure, leveraging Kubernetes for orchestration, Azure AI Foundry for model lifecycle management, and Azure Blob Storage for scalable data persistence. Established best practices for production-grade AI systems, including testing, observability, security, and scalability.\\
